...
public class Ninth2 extends JFrame implements ActionListener{
    JScrollPane scrollPane;
    ImageIcon icon;
    JTextArea l2;
    JButton b2;
    int count = 0;
    Thread n1 = new Thread(new ButtonSound());
    ...
    public Ninth2() {
        ...
        l2 = new JTextArea("\n\n    "+ Second.name.getText() +" : (어떻게 나가야 될까? 일단 짐은 두고 화장실 가는 척 몸만 나가자ㅎㅎ)");
		l2.setOpaque(true);
