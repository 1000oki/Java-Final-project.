...
public class Fourth2 extends JFrame implements ActionListener{
    JScrollPane scrollPane;
    ImageIcon icon;
    JTextArea l2;
    JButton b2;
    Thread tfourth = new Thread(new ButtonSound());
    ...
    public Fourth2() {
        ...
        l2 = new JTextArea("\n    "+ Second.name.getText() +" : 아 늦을 뻔 했네. 얼른 뛰어가서 출석부터 하자\n            헉헉... 학교 너무 가파른데??");
		l2.setOpaque(true);
