...
public class Ninth2_1 extends JFrame implements ActionListener{
    JScrollPane scrollPane;
    ImageIcon icon;
    JTextArea l2;
    JButton b2;
    int count = 0;
    Thread bl = new Thread(new ButtonSound());
    
    public Ninth2_1() {
    	    	   	
        icon = new ImageIcon("Ninth2-1.png");    
        ...
        l2 = new JTextArea("\n    "+ Second.name.getText() +" : 탈출 성공!! (소곤소곤) 이제 잠이 좀 깨는 것 같네 휴~\n            뒤에 효창공원 구경 좀 가볼까?");
		l2.setOpaque(true);
